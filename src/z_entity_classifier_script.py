...
def setup_paths():
    ...
    module_path = str(project_root / "ProDICT" / "src" / "data")
...
def load_data():
    ...
    held_out_path = '/home/lestrada/projects/ProDICT/data/test_run/held_out_df.xlsx'
    train_path = '/home/lestrada/projects/ProDICT/data/test_run/initial_training_df.xlsx'
    target_proteins_path = f"/home/lestrada/projects/ProDICT/data/BRCA_260122_results/BRCA_selected_features.txt"
...
def binary_labelling(training_df, held_out_df):
...
def main():
    ...
    # Load data
    held_out_df, train_df, target_proteins = load_data()
