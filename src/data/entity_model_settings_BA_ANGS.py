...
TARGET_CLASS = ['BA', 'ANGS']  # Change this for different tumor types (e.g., ['BRCA'], ['LUAD'], etc.)
...
FEATURE_SELECTION_L1_RATIOS = [0.3]  # L1 ratios to test for ElasticNet
FEATURE_SELECTION_C_VALUES = [1.5, 2]     # C values to test for ElasticNet
...
ELNET_N_JOBS = 20                        # Number of parallel jobs
